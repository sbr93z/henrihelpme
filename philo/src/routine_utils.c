...
/*   Updated: 2025/02/23 20:35:10 by sferrad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	take_forks(t_data *data, t_philo *philo)
{
	...
	if (philo->id % 2)
	{
		...
		if (data->end_simulation)
		{
			...
			// Unlock before return (pthread_mutex_unlock(&philo->right_fork->fork));
			return ;
		}
		...
		{
			pthread_mutex_unlock(&data->end_simulation_mutex);
			// Unlock before return (pthread_mutex_unlock(&philo->left_fork->fork));
